...
- Sweep grid (`hard_pool_size` only; everything else stays at the v4
  ...
  |----------|-----------------:|-----------------------|-------------------|
  | kcat_km  |          2,671   | 100 / 300 / 700 / 1400 | 3.7 % to 52 %   |
  | km       |          6,650   | 250 / 700 / 1700 / 3400 | 3.8 % to 51 %  |
  | turnover |          3,972   | 150 / 400 / 1000 / 2000 | 3.8 % to 50 %  |
...
- Abstract is not rewritten to claim enzyme-wide competitiveness; the
  abstract stays a BRENDA-200 paper. We avoid abstract scope-creep on
  a single-seed sweep result.
...
in {3.7 % to 52 %} of n_train_proteins did not lift matrix MRR above
...
- Before paper submission: outcomes A or B trigger §8.1 paragraph
  ...
  four-point curve.
- During revision: outcome C leads to a small Appendix B only;
  outcome D triggers the §8.1 + §8.2 + §9 revision per the rule above.
