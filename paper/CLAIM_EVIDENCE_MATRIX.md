...
| C6 | \method lifts matrix MRR 0.014→0.220±0.026, per-molecule AUC to 0.878±0.020, H@10 0→0.598±0.045 | multiseed CSV (pinned-split v5 sweep) | BRENDA-200 | 30 mols | 3 | replaces invalidated 0.326±0.072 (split leakage in pre-fix sweep); CIs in PAIRED_MOLECULE_STATS.md to refresh | Yes |
