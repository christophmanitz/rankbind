...
\title{\textbf{\method: Ligand-Conditional Ranking for\\ Drug--Target Interaction Benchmarks}}
...
(5{,}000 replicates) puts the \method--control \mrr{} difference at
$+0.23$ [95\% CI $+0.16$, $+0.32$], $+0.39$ [$+0.27$, $+0.52$] and $+0.43$
[$+0.32$, $+0.53$] for seeds 42/7/1337 --- every interval excludes zero,
and the same holds against the molecule-blind prior.
...
$3.4\times$ wider seed spread. The last row re-selects checkpoints by
