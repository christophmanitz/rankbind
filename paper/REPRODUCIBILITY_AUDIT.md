...
2. **Transfer per-seed additions**: RESOLVED 2026-08-22 — km_with_decoys
   s1337 landed (SLURM 27295353); `scripts/transfer_per_seed.py` regenerates
   `evaluation/attractor_results/bs_transfer_per_seed.csv` (12 rows,
   split-clean guard reuses `aggregate_multiseed.is_split_clean`).
